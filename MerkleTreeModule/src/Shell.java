...
/**
 * Text-based UI-class for the interaction with a Merkle-Tree. Can be used to build and to check a
 * tree.
 */
public class Shell {
  ...
  private static final String WRONG_MODE_ERROR =
      "Error! This action cannot be performed in this mode";
  ...
  private static final String NO_POSITION_ERROR =
      "Error! You need to specify a postion in the tree";
  private static final String NO_VALID_POSITION_ERROR =
      "Error! The specified position is not in the tree";
  ...
  private static final String CHECK_HELP_MESSAGE =
      "You are currently in check-mode.\n"
  ...
  private static final String BUILD_HELP_MESSAGE =
